...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      <a class="navbar-brand" href="IndustryPage.jsp">UniHub.lk</a>
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            ...
            <li>
             ...
             <li>
              ...
              <li>
              <a href="../view_event1.jsp">University Calender</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
           <li>
            ...
            <li>
              <a href="IndustryLogin.html">Industry</a>
            </li>
            <li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <form method="post" action="../uploadImageIndus" enctype="multipart/form-data">
            <table border="0">
                <tr>
                    <td> </td>
                ...
                <tr>
                    <td>comment: </td>
                    <td><input type="text" name="comm" size="50"/></td>
                </tr>
                <tr>
